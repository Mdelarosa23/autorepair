...
.process-item .process-four {
  padding-left: 80px;
  padding-right: 0;
  text-align: left;
}
.process-item .process-four i {
  left: 12px;
  right: unset;
}
.process-item .process-four i:after {
  left: -12px;
}
...
.review-area .review-bg {
  position: relative;
  background-image: url("assets/img/home-one/review/review-right.jpg");
  background-size: cover;
  background-position: center center;
  background-repeat: no-repeat;
  width: 100%;
...
.pricing-item .pricing-middle:before {
  ...
  border-right: 60px solid var(--theme-accent);
...
.pricing-item .pricing-middle:after {
  ...
  content: "";
  border-top: 25px solid transparent;
  border-left: 60px solid var(--theme-accent);
  border-bottom: 25px solid transparent;
  right: -45px;
  top: -15px;
  transform: rotate(-22deg);
...
/*-- Banner --*/
.banner-img-one {
  background-image: url("assets/img/home-three/banner-slider.jpg");
}

.banner-img-two {
  background-image: url("assets/img/home-three/banner-slider-two.jpg");
}

.banner-img-three {
  background-image: url("assets/img/home-three/banner-slider-three.jpg");
}
